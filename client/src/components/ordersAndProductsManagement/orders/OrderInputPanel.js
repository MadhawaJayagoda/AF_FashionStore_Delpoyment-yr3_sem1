            ...
            <div className="card-body mx-4 my-5">
                <form onSubmit={onFormSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <input className="form-control" id="partyName" name="partyName" value={orderPartyName} onChange={onChangeForm} placeholder="Customer or Supplier Name" />
                    </div>
                    <div className="form-group">
                    ...
                    <button type="submit" className="btn btn-success w-25 mt-5 h-25" style={{marginLeft:"10rem"}}>Add order</button>
                </form>
            </div>
        );
    }
